...
Deletes profile image set for a customer.

> Sample Request

```html
http://eu.api.capillarytech.com/v2/customers/343014824/deleteImage
```
...
| | |
--------- | ----------- |
URI | `/v2/customers/{userId}/deleteImage?{image_ids}`
HTTP Method | Delete
API Version | v2
Batch Support | No
Rate Limited | Yes
...
Parameter | Datatype | Description
--------- | -------- | -----------
userId* | long | Unique ID of the customer to delete profile image.
...
Lets you add consent of the customer to receive messages from the org. Mobile number validation is required to add consent that is generated through [otp/generate](https://capillary.github.io/api-documentation/#generate-otp) with the `"action":"SUBSCRIPTION"`.
...
```html
https://eu.api.capillarytech.com/v2/customers/traiConsent
```
...
Parameter | Datatype | Description
--------- | ----- | -----------
mobile* | string | Mobile number of the customer. Use the country code is it was used to generate OTP (`action`: `SUBSCRIPTION`)
consentStatus* | enum | Pass `yes` to provide consent to receive SMSs from the org, `no` to decline.
validationCode* | string | Unique validation code received on the customer's mobile number ( for the `SUBSCRIPTION``action`)
...
Lets you update consent of the customer to receive messages from the org. Mobile number validation is required to update consent that is generated through [otp/generate](https://capillary.github.io/api-documentation/#generate-otp) with the `"action":"SUBSCRIPTION"`.
...
Parameter | Datatype | Description
--------- | ----- | -----------
mobile* | string | Mobile number of the customer. Mention the country code if it was specified while generating the OTP (`action`:`SUBSCRIPTION`).
consentStatus* | enum | Pass `yes` to provide consent to receive SMSs from the org, `no` to decline.
validationCode* | string | Unique validation code received on the customer's mobile number ( for the `SUBSCRIPTION``action`)
